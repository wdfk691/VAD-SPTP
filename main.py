...
# Config
def get_configs():
    parser = argparse.ArgumentParser(description="VAD-PSTP config")
...
def train(args):
    ...
    # Load Data
    data_dir = f"E:/WL/Jigsaw-VAD-main/irip/wangguodong_2020/projects/datasets/vad/{args.dataset}/training"
    ...
    for epoch in range(args.epochs):
        for it, data in enumerate(vad_dataloader):
            ...
            if global_step % args.val_step == 0 and epoch >= 5:                  # 推理    原 5epoch————————————————————
...
def val(args, net=None):
    ...
    # Load Data
    data_dir = f"E:/WL/Jigsaw-VAD-main/irip/wangguodong_2020/projects/datasets/vad/{args.dataset}/testing"
